// From https://stackoverflow.com/questions/14733374/how-to-generate-md5-file-hash-on-javascript
...
function doIt() {
    ...
    for (var i = 0; i < hexHash2.length; i++) {
        var charAt = hexHash2.charAt(i);
        var value = parseInt(charAt, 16).toString(10) % 2 == 0 ? 0 : 1;
        binaryList.push(value);
    }
